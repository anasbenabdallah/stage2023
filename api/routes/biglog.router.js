...
biglogRouter.get("/getall", getbigLogs);

biglogRouter.post("/uploadAll", upload.single("csvFile"), async (req, res) => {
  try {
    ...
    await BigLog.insertMany(jsonArray); // Use await to wait for the promise to resolve
